...
function Subscribe() {
    return (
        <div  className='border lg:w-[90%] 2xl:w-[70%] w-full mx-auto  border-gray-600 p-4 lg:p-22 rounded-md   flex items-center justify-between lg:flex-row flex-col gap-5 lg:gap-0'>
